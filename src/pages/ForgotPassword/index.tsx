    ...
    <section className="flex overflow-hidden flex-col items-center px-20 pt-16 bg-white pb-[514px] max-md:px-5 max-md:pb-24">
      <div className="flex flex-col items-start w-full max-w-[1200px] max-md:max-w-full">
        ...
        <header className="flex flex-wrap gap-10 justify-between items-center self-stretch max-md:max-w-full">
          ...
          <img
            src="https://cdn.builder.io/api/v1/image/assets/877fbded3c1141a18415be7a6b510b08/bb32b9ef42a76c3a68973254e848404e63b2d43fc056bbb67f3278b26f01ef3c?placeholderIfAbsent=true"
            alt="User Icon"
        ...
        <section className="mt-12 leading-tight max-md:mt-10 max-md:max-w-full">
          <h1 className="text-4xl font-bold text-red-600 max-md:max-w-full">
            Have you forgotten your password?
          </h1>
          <p className="mt-5 text-xl font-medium tracking-tight text-neutral-700 max-md:max-w-full">
        ...
        <ForgeForm onSubmit={handleSubmit} className="w-full mt-5">
          ...
          <p className="mt-2 mb-11 text-sm font-medium tracking-tight leading-tight text-neutral-700 max-md:max-w-full">
            A link will be sent to this email address, click the link to verify
            your account.
          </p>

          <Button isLoading={isPending} className="w-60">
